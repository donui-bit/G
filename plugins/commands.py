    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ JOJU 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url=f"https://t.me/spjoju") ] ] ),
            )
        return
        ...
        for msg in msgs:
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    caption=f_caption,
                    protect_content=msg.get('protect', False),
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ JOJU 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url=f"https://envs.sh/npi.jpg") ] ] ),
                )
            except Exception as e:
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ J𝖮JU 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url="https://t.me/spjoju") ] ] ),
            )
            filetype = msg.media
